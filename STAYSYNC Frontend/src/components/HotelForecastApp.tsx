                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="property-input w-full px-4 py-3 pr-10 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white disabled:bg-gray-100 disabled:cursor-not-allowed"
                    />
                    {loadingProperties ? (
                    ...
                    {showDropdown && filteredProperties.length > 0 && (
                      <div className="property-dropdown absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg z-20 max-h-60 overflow-y-auto mt-1">
                        {filteredProperties.map((property, index) => (
                          ...
                          >
                            ...
                            <span className="text-sm text-gray-800">{property}</span>
                          </div>
                        ))}
                      </div>
                    )}
                    ...
                    {showDropdown && filteredProperties.length === 0 && selectedProperty.trim() && (
                      <div className="property-dropdown absolute top-full left-0 right-0 bg-white border border-gray-200 rounded-lg shadow-lg z-20 mt-1">
                        <div className="px-4 py-3 text-sm text-gray-500 text-center">
                          No properties found matching "{selectedProperty}"
                        </div>
                      </div>
                    )}
                  </div>
